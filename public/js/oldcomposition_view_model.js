...
window.CompositionViewModel = function(my_doremi_source) {
  ...
  self.redraw = function() {
    var composition_view, count_before, ctr, debug, doremi_source, parsed, parsed_line, parsed_lines, source, view_line, view_lines, warnings, _i, _j, _len, _len1, _ref, _results, _results1;
    try {
      debug = false;
