...
(function() {
  ...
  normalized_pitch_to_lilypond = function(pitch, context) {
    var EXAMPLES, begin_slur, chord, duration, end_slur, ending, extra_end_slur, first_fraction, grace1, grace2, grace_notes, in_slur, lilypond_octave, lilypond_pitch, lilypond_symbol_for_tie, mordent, ornament, rhythms, special_case, suppress_slurs;
    if (context == null) {
      context = {
        last_pitch: {},
        in_slur: false
